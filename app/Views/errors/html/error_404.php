...
<body class="bg-gray-50 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
    ...
    <main class="flex flex-col items-center justify-center min-h-screen pt-32 pb-16 px-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-10 flex flex-col items-center max-w-lg w-full">
            ...
            <h1 class="text-4xl font-bold mb-2 text-primary-700 dark:text-primary-400">404 - Página não encontrada</h1>
            <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">Desculpe, não conseguimos encontrar a página que você buscava.<br>Verifique o endereço ou volte para a página inicial.</p>
